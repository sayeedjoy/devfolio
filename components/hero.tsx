...
export function Hero() {
  ...
  return (
    <section id="about" className="pt-8 pb-5 sm:pt-10">
      ...
      {/* Icon-only tiles: the label is the accessible name, so the row stays
          the same compact height on a phone as it is on a desktop. */}
        ...
        {profile.socials.map((social) => {
          ...
          return (
            <a
              ...
              className="flex size-9 items-center justify-center rounded-lg border border-border/60 text-muted-foreground transition-colors hover:border-border hover:bg-foreground/[0.03] hover:text-foreground"
            >
