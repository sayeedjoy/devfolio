/**
 * Brand glyphs that lucide doesn't ship (it dropped brand icons upstream).
 * Kept in one module so the home contact block and the /about link list stay
 * in sync instead of each carrying its own copy of the paths.
 */
...
export function XIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.65l-5.22-6.82-5.96 6.82H1.68l7.73-8.84L1.25 2.25h6.82l4.71 6.23zm-1.16 17.52h1.83L7.08 4.13H5.12z" />
    </svg>
  )
}
